...
<div class="container mx-auto flex flex-col justify-center px-6">
    <div class="mb-14 flex flex-wrap items-center justify-center gap-10 sm:mb-20 sm:gap-20">
        ...
        <div class="group">
            <div class="mb-2 text-xl sm:text-2xl transition-all">
                <span class="me-2 font-light">👋 Hi,</span>
            </div>
            <h2 class="text-[2.75rem] font-black transition-all sm:text-7xl">
                <span class="font-light">I'm</span> Le Thanh Trung
            </h2>
        </div>
    </div>
    <div class="mb-32 text-center">
        <h2 class="mb-6 text-3xl font-bold sm:mb-8 sm:text-4xl">
            I'm a <span class="text-blue-500 underline underline-offset-8">Backend Developer</span>
        </h2>
        ...
        <div class="mt-20">
            ...
            <div class="mt-3 flex flex-wrap items-center justify-center gap-5">
                <a href="{{ route('cv') }}" class="group flex items-center space-x-2 text-zinc-500 font-medium hover:text-zinc-800 relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-zinc-800 after:transition-all after:duration-300 after:ease-in-out after:scale-x-0 hover:after:scale-x-100 after:origin-left">
                    <span class="text-2xl">
                    ...
                    <span class="text-lg">My Resume</span>
                </a>
                <a href="https://github.com/thanhtrungit97" class="group flex items-center space-x-2 text-zinc-500 font-medium hover:text-zinc-800 relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-zinc-800 after:transition-all after:duration-300 after:ease-in-out after:scale-x-0 hover:after:scale-x-100 after:origin-left">
                    <span class="text-2xl">
                ...
                <a href="https://linkedin.com/in/thanhtrungit" class="group flex items-center space-x-2 text-zinc-500 font-medium hover:text-zinc-800 relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-zinc-800 after:transition-all after:duration-300 after:ease-in-out after:scale-x-0 hover:after:scale-x-100 after:origin-left">
                    <span class="text-2xl">
                ...
                <a href="https://threads.net/thanhtrungit307" class="group flex items-center space-x-2 text-zinc-500 font-medium hover:text-zinc-800 relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-zinc-800 after:transition-all after:duration-300 after:ease-in-out after:scale-x-0 hover:after:scale-x-100 after:origin-left">
                    <span class="text-2xl">
                    ...
                    <span class="text-lg">Threads</span>
                </a>
                <div class="flex items-center gap-2 text-zinc-500">
                    ...
                    <p class="text-lg">
                        <a href="https://www.facebook.com/thanhtrungit97" class="group flex items-center space-x-2 text-zinc-500 font-medium hover:text-zinc-800 relative after:absolute after:-bottom-1 after:left-0 after:w-full after:h-0.5 after:bg-zinc-800 after:transition-all after:duration-300 after:ease-in-out after:scale-x-0 hover:after:scale-x-100 after:origin-left">
                            <span class="text-lg">Thành Trung</span>
                        </a>
                    </p>
                </div>
            </div>
